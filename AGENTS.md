...
4. **Do not invent view kinds.** There are exactly 15. See the table in [README.md](README.md) and [skills/sysmld-compose-views/SKILL.md](skills/sysmld-compose-views/SKILL.md).
...
6. **Vision review before calling a view done.** Tests passing is not enough. Open the SVG/PNG and look. Use [skills/sysmld-review-views/SKILL.md](skills/sysmld-review-views/SKILL.md).
...
- New user project: [skills/sysmld-bootstrap/SKILL.md](skills/sysmld-bootstrap/SKILL.md) and [templates/new-system/](templates/new-system/).
- Write or edit textual SysML: [skills/sysmld-author-model/SKILL.md](skills/sysmld-author-model/SKILL.md).
- Intent JSON + composer command: [skills/sysmld-compose-views/SKILL.md](skills/sysmld-compose-views/SKILL.md).
- Visual / meaning QA: [skills/sysmld-review-views/SKILL.md](skills/sysmld-review-views/SKILL.md).

Copy `templates/new-system/` for a greenfield model. Do not clone toaster as the starter.
