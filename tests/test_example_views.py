...
class ExampleViewTests(unittest.TestCase):
    ...
    def test_architecture_notes_are_simplified_magicgrid_walkthroughs(self):
        ...
        self.assertNotIn("Heat to bread", toaster)
        self.assertNotIn("extends Toast Bread", toaster)
        self.assertNotIn("included by Toast Bread", toaster)
        ...
        self.assertNotIn("extends Make Smoothie", blender)
        self.assertNotIn("included by Make Smoothie", blender)
