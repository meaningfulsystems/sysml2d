...
class ExampleViewTests(unittest.TestCase):
    ...
    def test_architecture_notes_are_simplified_magicgrid_walkthroughs(self):
        ...
        self.assertNotIn("One-page overview", apollo)
        self.assertNotIn("Problem domain", apollo)
        self.assertNotIn("Solution domain", apollo)
        self.assertNotIn("This paper", apollo)
        self.assertNotIn("the team will now", apollo)
        self.assertNotIn("Sourced shalls", apollo)
        ...
        self.assertNotRegex(apollo, r"\bI'm\b")
        ...
        self.assertIn("Kurten. (1975, July). *Abort Guidance System* (Technical Note D-7990).", apollo)
        self.assertIn("Lutz et al. (1975, November). *Development of the Extravehicular Mobility Unit* (Technical Note D-8093).", apollo)
        self.assertIn("(1973a, March). *Apollo Experience Report: Ascent Propulsion System* (Technical Note D-7082).", apollo)
        self.assertIn("(1973b, March). *Apollo Experience Report: Descent Propulsion System* (Technical Note D-7143).", apollo)
        self.assertIn("(1973c, August). *Apollo Experience Report: Service Propulsion Subsystem* (Technical Note D-7375).", apollo)
        self.assertIn("(1972). *Apollo Experience Report: Lunar Module Environmental Control Subsystem* (Technical Note D-6724).", apollo)
